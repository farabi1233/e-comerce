...
<div class="content-wrapper">
  ...
  <section class="content">
    <div class="container-fluid">
              ...
              <div class="tab-pane" id="picture">
                <form method="POST" enctype="multipart/form-data" class="form-horizontal" id="updateProfilePicture" name="updateProfilePicture">
                  ...
                  <div class="form-group row" style="padding-top: 30px">
                    ...
                    <img class="img-bordered" id="showImage" @if(empty($user['image'])) src="{{asset('upload/not_found.png')}}" @else src="{{ url($user['image']) }}" @endif width="150px" height="150px" alt="">
                  </div>
                  <div class="form-group row">
                    <div class="offset-sm-2 col-sm-10">
      ...
      <div class="col-md-4">
      @include('backend.admin.profile.profile_details')</div>
    </div>
</div>
